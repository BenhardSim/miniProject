                ...
                <dl class="row align-content-center">
                    <?php
                       require_once('../lib/db_login.php');
                        $kode_kota = $_GET['kode_kota']; // mendapatkan kode provinsi yang dilewatkan ke url
                        ...
                        while ($row = $result->fetch_object()) {
                            echo '<dt class="col-sm-3">Nama Kota</dt>';
                            echo '<dd class="col-sm-9">' . $row->Nama_Kota . '</dd>';

                            echo '<dt class="col-sm-3">Gubernur</dt>';
                            echo '<dd class="col-sm-9">' . $row->Walikota . '</dd>';

                            echo '<dt class="col-sm-3">Wakil Gubernur</dt>';
                            echo '<dd class="col-sm-9">' . $row->Wakil_Walikota . '</dd>';
